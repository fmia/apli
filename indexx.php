...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="files/css/bootstrap-theme.min.css">    <link rel="stylesheet" type="text/css" href="files/css/AdminLTE.css">
    ...
    session_start();
                      if(isset($_GET['provincia']) && isset($_GET['idprovfrom'])){
                          ...
                          while ($extraido= mysqli_fetch_array($result)) {
                                            ?>
                                            <option value="<?php echo 'http://127.0.0.1/hogarium_apli/indexx.php?idprovfrom='.$extraido['id_provincia'].'&provincia='.$extraido['provincia'];?>">
                                                <?php 
                              echo ($extraido['id_provincia']. ' - '.$extraido['provincia']);
                                    ...
                                    <select id="dynamic_select3" name="enviofrom" class="form-control selectpicker dropup" >                                 							
                                        ...
                                        ?>
                                        <option  value="<?php echo 'http://127.0.0.1/hogarium_apli/indexx.php?idprovfrom='.$_GET['idprovfrom'].'&provincia='.$_GET['provincia'].'&cpfrom='.$rowfrom[0].'&pobfrom='.$rowfrom[1];?>"><?php echo $rowfrom[0].'-'.$rowfrom[1];?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <select name="to" id="dynamic_select2" class="form-control selectpicker">
                                        <optgroup value="67" label="España-peninsular">
                                            ...
                                            <?php
                                                ...
                                                while ($extraido= mysqli_fetch_array($result)) {
                                            ?>
                                            <option value="<?php echo 'http://127.0.0.1/hogarium_apli/indexx.php
									?idprovfrom='.$_GET['idprovfrom'].'
									&provincia='.$_GET['provincia'].'
									&cpfrom='.$_GET['cpfrom'].'
									&pobfrom='.$_GET['pobfrom'].'
