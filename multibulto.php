  ...
  <form id="bootstrapSelectForm" method="post" class="form-horizontal" action="recoge.php">
    <div class="row" id="contenedorFormulario">
      ...
      <div class="btn-group btn-group-lg">
        ...
        <button type="button" class="btn-sm btn-info" onclick="location.href='multibulto2.php';"><span class="glyphicon glyphicon-plus"></span></button>
        <button type="button" class="btn-sm btn-info" onclick="location.href='index.php';"><span class="glyphicon glyphicon-minus"></span></button>
      </div>
